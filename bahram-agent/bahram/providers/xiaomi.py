...
class XiaomiProvider(BaseProvider):
    ...
    async def complete(
        ...
        **kwargs: Any,
        ...
        """Generate a completion using Xiaomi MiMo API."""
        try:
            import httpx
            ...
            logger.error(f"Xiaomi MiMo API error: {e}")
            raise
    ...
    async def stream(
        ...
        **kwargs: Any,
        ...
        """Stream a completion using Xiaomi MiMo API."""
        try:
            import httpx
            ...
            logger.error(f"Xiaomi MiMo stream error: {e}")
            raise
